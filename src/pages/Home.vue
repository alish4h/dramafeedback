<template>
  <f7-page>
    ...
    <f7-list v-show="!authenticated">
      <f7-list-button fill-ios='true' big-ios='true' @click='signIn'>Sign In</f7-list-button>
    ...
    <!-- POST SIGN IN VIEW -->
    <f7-list v-show="authenticated">
      <f7-list-button fill-ios='true' big-ios='true' @click="$f7router.navigate('/students/')">Students</f7-list-button>
      <f7-list-button fill-ios='true' big-ios='true' @click="$f7router.navigate('/performance/')">Performance</f7-list-button>
      <f7-list-button fill-ios='true' big-ios='true' @click="$f7router.navigate('/settings/')">Settings</f7-list-button>
      <f7-list-button fill-ios='true' big-ios='true' @click="$f7router.navigate('/session/')">Start Session</f7-list-button>
    </f7-list>
